          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-secondary/5 text-muted-foreground">
                  Or continue with
                </span>
              </div>
            </div>
            ...
            <div className="mt-6">
              <button
                ...
                className="w-full flex items-center justify-center gap-3 px-4 py-2.5 border border-border/50 rounded-lg shadow-sm bg-white text-sm font-medium text-foreground hover:bg-secondary/5 transition-colors"
              >
