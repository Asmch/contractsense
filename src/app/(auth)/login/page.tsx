    ...
    <div className="min-h-screen bg-background flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        ...
        <p className="mt-2 text-center text-sm text-muted-foreground">
          ...
          <Link href="/signup" className="font-medium text-primary hover:text-primary/80 transition-colors hover:underline">
        ...
        <div className="relative group">
          ...
          <div className="relative backdrop-blur-xl bg-background/60 py-8 px-4 sm:rounded-2xl sm:px-10 border border-border/40 shadow-2xl">
            ...
            <div className="mt-6 flex items-center">
              ...
              <div className="px-4 text-xs text-muted-foreground uppercase tracking-wider font-medium">Or continue with</div>
              <div className="flex-1 border-t border-border/40"></div>
            </div>
            ...
            <form className="mt-6 space-y-5" onSubmit={handleSubmit}>
              ...
              <div className="flex items-center">
                <input
                  ...
                  name="remember-me"
                  type="checkbox"
                  className="h-4 w-4 text-primary focus:ring-primary/20 border-border/50 rounded bg-background/50 transition-colors cursor-pointer"
                />
                <label htmlFor="remember-me" className="ml-2.5 block text-sm text-muted-foreground cursor-pointer">
              ...
              <button
                ...
                className="w-full flex justify-center py-2.5 px-4 border border-transparent rounded-xl shadow-md shadow-primary/20 text-sm font-medium text-primary-foreground bg-primary hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary focus:ring-offset-background disabled:opacity-50 transition-all duration-200"
              >
                {isLoading ? <Loader2 className="w-5 h-5 animate-spin" /> : "Sign in to your account"}
              </button>
            </form>
          </div>
        </div>
